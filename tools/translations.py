...
T = {
    ...
    "preview_minimize": dict(hi="छोटा करें", es="Minimizar", pt="Minimizar", id="Perkecil", zh="最小化"),
    "acp_history_search": dict(hi="सेशन खोजें", es="Buscar sesiones", pt="Pesquisar sessões", id="Cari sesi", zh="搜索会话"),
    "acp_history_no_match": dict(hi="“%1$s” से कोई सेशन मेल नहीं खाता", es="Ninguna sesión coincide con “%1$s”", pt="Nenhuma sessão corresponde a “%1$s”", id="Tidak ada sesi yang cocok dengan “%1$s”", zh="没有与“%1$s”匹配的会话"),
    "acp_history_delete_confirm": dict(hi="यह सेशन हटाएँ?", es="¿Eliminar esta sesión?", pt="Excluir esta sessão?", id="Hapus sesi ini?", zh="删除此会话？"),
    "acp_agent_unsupported_title": dict(hi="Android पर चैट के रूप में उपलब्ध नहीं", es="No disponible como chat en Android", pt="Não disponível como chat no Android", id="Tidak tersedia sebagai chat di Android", zh="在 Android 上无法以聊天方式使用"),
    "acp_antigravity_unsupported": dict(hi="Google Antigravity का चैट सर्वर Android पर नहीं चल सकता। इसके बजाय Shell सेशन में agy कमांड इस्तेमाल करें। आप यह चैट सेशन हटा सकते हैं।", es="El servidor de chat de Google Antigravity no puede funcionar en Android. Usa el comando agy en una sesión de Shell. Puedes eliminar esta sesión de chat.", pt="O servidor de chat do Google Antigravity não roda no Android. Use o comando agy numa sessão de Shell. Você pode excluir esta sessão de chat.", id="Server chat Google Antigravity tidak dapat berjalan di Android. Gunakan perintah agy di sesi Shell. Anda bisa menghapus sesi chat ini.", zh="Google Antigravity 的聊天服务器无法在 Android 上运行。请在 Shell 会话中使用 agy 命令。你可以删除此聊天会话。"),
